...
OIDC_RESPONSE_TYPES = OIDC_OP_CONFIG['op']['server_info'][
    'endpoint']['authorization']['kwargs']['response_types_supported']

OIDC_TOKEN_AUTHN_METHODS = OIDC_OP_CONFIG['op']['server_info'][
    'endpoint']['token']['kwargs']['client_authn_method']

OIDC_GRANT_TYPES = OIDC_OP_CONFIG['op']['server_info']['capabilities']['grant_types_supported']
